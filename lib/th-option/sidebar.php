<div class="sidebar-section">
            ...
            <h3 class="hndle ui-sortable-handle">
                <span><?php _e('Gogo WordPress Theme','gogo'); ?> </span>
            </h3>
            <p>
            ...
            <div class="section">
                <h3><?php _e('Video Tutorials','gogo'); ?></h3>
                <p><?php _e('Want a guide? We have video tutorials to walk you through getting started.','gogo'); ?> </p>
                <a href="https://www.youtube.com/watch?v=5jZ1GTeieug" target="_blank" class="sidebar-link"><?php _e('Watch Videos','gogo'); ?></a>
            </div>
            <hr>
