	...
	<div id="primary" class="main content-area">
		<main id="main" class="site-main" role="main">
			...
			if( have_posts()):?>
				...
				<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'gogo' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
			</header><!-- .page-header -->
				<?php /* Start the Loop */
